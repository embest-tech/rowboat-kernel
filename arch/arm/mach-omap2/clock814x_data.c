...
static struct omap_clk ti814x_clks[] = {
	...
	CLK("davinci-mcasp.3",	"ick",				&mcasp4_ick,			CK_TI814X),
	CLK("davinci-mcasp.4",	"ick",				&mcasp5_ick,			CK_TI814X),
	CLK("davinci-mcasp.5",	"ick",				&mcasp6_ick,			CK_TI814X),
	...
	CLK("davinci-mcasp.0",	"ick",				&mcasp1_ick,			CK_TI814X),
	CLK("davinci-mcasp.1",	"ick",				&mcasp2_ick,			CK_TI814X),
	CLK("davinci-mcasp.2",	"ick",				&mcasp3_ick,			CK_TI814X),
	CLK("omap-mcbsp.1",	"ick",				&mcbsp_ick,			CK_TI814X),
	CLK(NULL,		"gpmc_fck",			&gpmc_fck,			CK_TI814X),
	CLK(NULL,		"hdmi_ick",			&hdmi_ick,			CK_TI814X),
	CLK(NULL,		"mlbp_ick",			&mlbp_ick,			CK_TI814X),
	CLK("omap_wdt",		"ick",				&wdt1_ick,			CK_TI814X),
	CLK(NULL,		"wdt2_ick",			&wdt2_ick,			CK_TI814X),
	...
	CLK("omap-mcbsp.1",	"fck",				&mcbsp_fck,			CK_TI814X),
	CLK("davinci-mcasp.0",	"fck",				&mcasp1_fck,			CK_TI814X),
	CLK("davinci-mcasp.1",	"fck",				&mcasp2_fck,			CK_TI814X),
	CLK("davinci-mcasp.2",	"fck",				&mcasp3_fck,			CK_TI814X),
	...
	CLK("mmci-omap-hs.0",	"dbck",				&mmchs1_dbck,			CK_TI814X),
	CLK("mmci-omap-hs.1",	"dbck",				&mmchs2_dbck,			CK_TI814X),
	CLK("mmci-omap-hs.2",	"dbck",				&mmchs3_dbck,			CK_TI814X),
	...
	CLK("davinci-mcasp.3",	"fck",				&mcasp4_fck,			CK_TI814X),
	CLK("davinci-mcasp.4",	"fck",				&mcasp5_fck,			CK_TI814X),
	CLK("davinci-mcasp.5",	"fck",				&mcasp6_fck,			CK_TI814X),
	CLK("davinci-mcasp.0",	"ahxck",			&mcasp1_ahx_ck,			CK_TI814X),
	CLK("davinci-mcasp.0",	"ahrck",			&mcasp1_ahr_ck,			CK_TI814X),
	CLK("davinci-mcasp.1",	"ahxck",			&mcasp2_ahx_ck,			CK_TI814X),
	CLK("davinci-mcasp.1",	"ahrck",			&mcasp2_ahr_ck,			CK_TI814X),
	CLK("davinci-mcasp.2",	"ahxck",			&mcasp3_ahx_ck,			CK_TI814X),
	CLK("davinci-mcasp.3",	"ahxck",			&mcasp4_ahx_ck,			CK_TI814X),
	CLK("davinci-mcasp.4",	"ahxck",			&mcasp5_ahx_ck,			CK_TI814X),
	CLK("davinci-mcasp.5",	"ahxck",			&mcasp6_ahx_ck,			CK_TI814X),
	...
	CLK("omap_wdt",		"fck",				&wdt1_fck,			CK_TI814X),
	CLK(NULL,		"wdt2_fck",			&wdt2_fck,			CK_TI814X),
