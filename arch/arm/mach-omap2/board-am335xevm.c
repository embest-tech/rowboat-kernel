...
static struct pinmux_config spi0_pin_mux[] = {
	{"spi0_sclk.spi0_sclk", OMAP_MUX_MODE0 | AM335X_PULL_ENBL
							| AM335X_INPUT_EN},
	{"spi0_d0.spi0_d0", OMAP_MUX_MODE0 | AM335X_PULL_ENBL | AM335X_PULL_UP
							| AM335X_INPUT_EN},
	{"spi0_d1.spi0_d1", OMAP_MUX_MODE0 | AM335X_PULL_ENBL
							| AM335X_INPUT_EN},
	{"spi0_cs0.spi0_cs0", OMAP_MUX_MODE0 | AM335X_PULL_ENBL | AM335X_PULL_UP
							| AM335X_INPUT_EN},
	{NULL, 0},
};
...
static struct pinmux_config spi1_pin_mux[] = {
	{"mcasp0_aclkx.spi1_sclk", OMAP_MUX_MODE3 | AM335X_PULL_ENBL
		| AM335X_INPUT_EN},
	{"mcasp0_fsx.spi1_d0", OMAP_MUX_MODE3 | AM335X_PULL_ENBL
		| AM335X_PULL_UP | AM335X_INPUT_EN},
	{"mcasp0_axr0.spi1_d1", OMAP_MUX_MODE3 | AM335X_PULL_ENBL
		| AM335X_INPUT_EN},
	{"mcasp0_ahclkr.spi1_cs0", OMAP_MUX_MODE3 | AM335X_PULL_ENBL
		| AM335X_PULL_UP | AM335X_INPUT_EN},
	{NULL, 0},
};
...
static struct pinmux_config matrix_keypad_pin_mux[] = {
	{"gpmc_a5.gpio1_21",  OMAP_MUX_MODE0 | AM335X_PIN_OUTPUT},
	{"gpmc_a8.gpio1_24",  OMAP_MUX_MODE0 | AM335X_PIN_OUTPUT},
	{"gpmc_a9.gpio1_25",  OMAP_MUX_MODE0 | AM335X_PIN_INPUT},
	{"gpmc_a10.gpio1_26", OMAP_MUX_MODE0 | AM335X_PIN_INPUT},
	{"gpmc_a11.gpio1_27", OMAP_MUX_MODE0 | AM335X_PIN_INPUT},
	{NULL, 0},
};
...
static struct pinmux_config volume_keys_pin_mux[] = {
        {"gpmc_a5.gpio0_2",  OMAP_MUX_MODE0 | AM335X_PIN_INPUT},
        {"gpmc_a8.gpio0_3",  OMAP_MUX_MODE0 | AM335X_PIN_INPUT},
        {NULL, 0},
};
...
static struct omap_board_mux board_mux[] __initdata = {
	...
	AM335X_MUX(UART0_RXD, OMAP_MUX_MODE0 | AM335X_PIN_INPUT_PULLUP),
	AM335X_MUX(UART0_TXD, OMAP_MUX_MODE0 | AM335X_PULL_ENBL),
