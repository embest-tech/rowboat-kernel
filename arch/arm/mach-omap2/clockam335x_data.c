...
static struct dpll_data dpll_per_dd = {
	...
	.mult_mask	= AM335X_DPLL_MULT_PERIPH_MASK,
	.div1_mask	= AM335X_DPLL_PER_DIV_MASK,
...
static struct omap_clk am335x_clks[] = {
	...
	CLK("da8xx_lcdc.0",	NULL,		&lcdc_fck,	CK_AM335X),
	CLK(NULL,	"mailbox0_fck",		&mailbox0_fck,	CK_AM335X),
	CLK(NULL,               "mcasp1_ick",   &mcasp0_ick,	CK_AM335X),
	CLK(NULL,               "mcasp2_ick",   &mcasp1_ick,	CK_AM335X),
	...
	CLK(NULL,	"lcdc_ick_l3_clk",	&lcdc_l3ick,	CK_AM335X),
	CLK(NULL,	"lcdc_ick_l4_clk",	&lcdc_l4ick,	CK_AM335X),
