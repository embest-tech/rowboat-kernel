/*
 * AM335x PRM instance offset macros
 *
...
#ifndef __ARCH_ARM_MACH_OMAP2_PRMAM335X_H
#define __ARCH_ARM_MACH_OMAP2_PRMAM335X_H
...
#define AM335X_PRM_REGADDR(inst, reg)                         \
	AM335X_L4_WK_IO_ADDRESS(AM335X_PRM_BASE + (inst) + (reg))
