...
static struct omap_mux __initdata am335x_muxmodes[] = {
	...
	_AM335X_MUXENTRY(GPMC_AD8, 0,
		"gpmc_ad8", NULL, "mmc1_dat0", "mmc2_dat4",
		NULL, NULL, NULL, NULL),
	_AM335X_MUXENTRY(GPMC_AD9, 0,
		"gpmc_ad9", NULL, "mmc1_dat1", "mmc2_dat5",
		NULL, NULL, NULL, NULL),
	_AM335X_MUXENTRY(GPMC_AD10, 0,
		"gpmc_ad10", NULL, "mmc1_dat2", "mmc2_dat6",
		NULL, NULL, NULL, NULL),
	_AM335X_MUXENTRY(GPMC_AD11, 0,
		"gpmc_ad11", NULL, "mmc1_dat3", "mmc2_dat7",
		NULL, NULL, NULL, NULL),
	_AM335X_MUXENTRY(GPMC_AD12, 0,
		"gpmc_ad12", NULL, "mmc1_dat4", "mmc2_dat0",
		NULL, NULL, NULL, NULL),
	_AM335X_MUXENTRY(GPMC_AD13, 0,
		"gpmc_ad13", NULL, "mmc1_dat5", "mmc2_dat1",
		NULL, NULL, NULL, NULL),
	_AM335X_MUXENTRY(GPMC_AD14, 0,
		"gpmc_ad14", NULL, "mmc1_dat6", "mmc2_dat2",
		NULL, NULL, NULL, NULL),
	_AM335X_MUXENTRY(GPMC_AD15, 0,
		"gpmc_ad15", NULL, "mmc1_dat7", "mmc2_dat3",
		NULL, NULL, NULL, NULL),
	_AM335X_MUXENTRY(GPMC_A0, 0,
		NULL, NULL, "rgmii2_tctl", NULL,
		NULL, NULL, NULL, NULL),
	_AM335X_MUXENTRY(GPMC_A1, 0,
		"gpmc_a1", NULL, "rgmii2_rctl", "mmc2_dat0",
		NULL, NULL, NULL, NULL),
	_AM335X_MUXENTRY(GPMC_A2, 0,
		"gpmc_a2", NULL, "rgmii2_td3", "mmc2_dat1",
		NULL, NULL, NULL, NULL),
	_AM335X_MUXENTRY(GPMC_A3, 0,
		"gpmc_a3", NULL, "rgmii2_td2", "mmc2_dat2",
		NULL, NULL, NULL, NULL),
	...
	_AM335X_MUXENTRY(GPMC_A6, 0,
		"gpmc_a6", NULL, "rgmii2_tclk", "mmc2_dat4",
		NULL, NULL, NULL, NULL),
	_AM335X_MUXENTRY(GPMC_A7, 0,
		"gpmc_a7", NULL, "rgmii2_rclk", "mmc2_dat5",
		NULL, NULL, NULL, NULL),
	_AM335X_MUXENTRY(GPMC_A8, 0,
		"gpmc_a8", NULL, "rgmii2_rd3", "mmc2_dat6",
		NULL, NULL, "mcasp0_aclkx", NULL),
	_AM335X_MUXENTRY(GPMC_A9, 0,
		"gpmc_a9", NULL, "rgmii2_rd2", "mmc2_dat7",
	...
	_AM335X_MUXENTRY(GPMC_WAIT0, 0,
		"gpmc_wait0", NULL, NULL, "mmc1_sdcd",
		NULL, NULL, NULL, NULL),
	_AM335X_MUXENTRY(GPMC_WPN, 0,
		"gpmc_wpn", NULL, NULL, "mmc2_sdcd",
		NULL, NULL, NULL, NULL),
	_AM335X_MUXENTRY(GPMC_BEN1, 0,
		"gpmc_ben1", NULL, "mmc2_dat3", NULL,
	...
	_AM335X_MUXENTRY(SPI0_D1, 0,
		"spi0_d1", "mmc1_sdwp", NULL, NULL,
		NULL, NULL, NULL, NULL),
	_AM335X_MUXENTRY(SPI0_CS0, 0,
		"spi0_cs0", "mmc2_sdwp", NULL, NULL,
		NULL, NULL, NULL, NULL),
	_AM335X_MUXENTRY(SPI0_CS1, 0,
		"spi0_cs1", NULL, NULL, "mmc0_pow",
		NULL, "mmc0_sdcd", NULL, NULL),
	_AM335X_MUXENTRY(ECAP0_IN_PWM0_OUT, 0,
		"ecap0_in_pwm0_out", NULL, NULL, NULL,
		NULL, "mmc0_sdwp", NULL, NULL),
	...
	_AM335X_MUXENTRY(UART0_RXD, 0,
		"uart0_rxd", "mmc1_sdwp", NULL, NULL,
		NULL, NULL, NULL, NULL),
	_AM335X_MUXENTRY(UART0_TXD, 0,
		"uart0_txd", "mmc2_sdwp", NULL, NULL,
		NULL, NULL, NULL, NULL),
