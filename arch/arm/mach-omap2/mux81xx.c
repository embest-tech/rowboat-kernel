...
static struct omap_mux __initdata am335x_muxmodes[] = {
	...
	_AM335X_MUXENTRY(LCD_DATA0, 0,
		"lcd_data0", NULL, NULL, NULL,
		NULL, NULL, NULL, NULL),
	_AM335X_MUXENTRY(LCD_DATA1, 0,
		"lcd_data1", NULL, NULL, NULL,
		NULL, NULL, NULL, NULL),
	_AM335X_MUXENTRY(LCD_DATA2, 0,
		"lcd_data2", NULL, NULL, NULL,
		NULL, NULL, NULL, NULL),
	_AM335X_MUXENTRY(LCD_DATA3, 0,
		"lcd_data3", NULL, NULL, NULL,
		NULL, NULL, NULL, NULL),
	_AM335X_MUXENTRY(LCD_DATA4, 0,
		"lcd_data4", NULL, NULL, NULL,
		NULL, NULL, NULL, NULL),
	_AM335X_MUXENTRY(LCD_DATA5, 0,
		"lcd_data5", NULL, NULL, NULL,
		NULL, NULL, NULL, NULL),
	_AM335X_MUXENTRY(LCD_DATA6, 0,
		"lcd_data6", NULL, NULL, NULL,
		NULL, NULL, NULL, NULL),
	_AM335X_MUXENTRY(LCD_DATA7, 0,
		"lcd_data7", NULL, NULL, NULL,
		NULL, NULL, NULL, NULL),
	_AM335X_MUXENTRY(LCD_DATA8, 0,
		"lcd_data8", NULL, NULL, "mcasp0_aclkx",
		NULL, NULL, NULL, NULL),
	_AM335X_MUXENTRY(LCD_DATA9, 0,
		"lcd_data9", NULL, NULL, "mcasp0_fsx",
		NULL, NULL, NULL, NULL),
	_AM335X_MUXENTRY(LCD_DATA10, 0,
		"lcd_data10", NULL, NULL, "mcasp0_axr0",
		NULL, NULL, NULL, NULL),
	...
	_AM335X_MUXENTRY(LCD_DATA13, 0,
		"lcd_data13", NULL, NULL, "mcasp0_fsr",
		"mcasp0_axr3", NULL, NULL, NULL),
	_AM335X_MUXENTRY(LCD_DATA14, 0,
		"lcd_data14", NULL, NULL, "mcasp0_axr1",
		NULL, NULL, NULL, NULL),
	_AM335X_MUXENTRY(LCD_DATA15, 0,
		"lcd_data15", NULL, NULL, "mcasp0_ahclkx",
		"mcasp0_axr3", NULL, NULL, NULL),
	_AM335X_MUXENTRY(GPMC_AD8, 0,
	...
	_AM335X_MUXENTRY(GPMC_AD10, 0,
		...
		NULL, NULL, NULL, NULL),
	_AM335X_MUXENTRY(GPMC_AD11, 0,
		"gpmc_ad11", "lcd_data19", NULL, NULL,
		NULL, NULL, NULL, NULL),
	_AM335X_MUXENTRY(GPMC_AD12, 0,
		"gpmc_ad12", "lcd_data20", NULL, NULL,
		NULL, NULL, NULL, NULL),
	_AM335X_MUXENTRY(GPMC_AD13, 0,
		"gpmc_ad13", "lcd_data21", NULL, NULL,
		NULL, NULL, NULL, NULL),
	_AM335X_MUXENTRY(GPMC_AD14, 0,
		"gpmc_ad14", "lcd_data22", NULL, NULL,
		NULL, NULL, NULL, NULL),
	_AM335X_MUXENTRY(GPMC_AD15, 0,
		"gpmc_ad15", "lcd_data23", NULL, NULL,
		NULL, NULL, NULL, NULL),
	...
	_AM335X_MUXENTRY(MII1_COL, 0,
		"mii1_col", "rmii2_refclk", NULL, NULL,
		"mcasp1_axr2", NULL, "mcasp0_axr2", NULL),
	_AM335X_MUXENTRY(MII1_CRS, 0,
		"mii1_crs", NULL, NULL, NULL,
		"mcasp1_aclkx", NULL, NULL, NULL),
	_AM335X_MUXENTRY(MII1_RXERR, 0,
		"mii1_rxerr", NULL, NULL, NULL,
		"mcasp1_fsx", NULL, NULL, NULL),
	_AM335X_MUXENTRY(MII1_TXEN, 0,
		"mii1_txen", NULL, "rgmii1_tctl", NULL,
		"mcasp1_axr0", NULL, NULL, NULL),
	_AM335X_MUXENTRY(MII1_RXDV, 0,
		"mii1_rxdv", NULL, "rgmii1_rctl", NULL,
		"mcasp1_aclx", NULL, "mcasp0_aclkr", NULL),
	_AM335X_MUXENTRY(MII1_TXD3, 0,
		"mii1_txd3", NULL, "rgmii1_td3", NULL,
		"mcasp1_fsx", NULL, "mcasp0_fsr", NULL),
	_AM335X_MUXENTRY(MII1_TXD2, 0,
		"mii1_txd2", NULL, "rgmii1_td2", NULL,
		"mcasp1_axr0", NULL, "mcasp0_ahclkx", NULL),
	_AM335X_MUXENTRY(MII1_TXD1, 0,
		"mii1_txd1", NULL, "rgmii1_td1", "mcasp1_fsr",
		"mcasp1_axr1", NULL, NULL, NULL),
	_AM335X_MUXENTRY(MII1_TXD0, 0,
		"mii1_txd0", NULL, "rgmii1_td0", "mcasp1_axr2",
		"mcasp1_aclkr", NULL, NULL, NULL),
	_AM335X_MUXENTRY(MII1_TXCLK, 0,
		"mii1_txclk", NULL, "rgmii1_tclk", NULL,
		NULL, NULL, "mcasp0_aclkx", NULL),
	_AM335X_MUXENTRY(MII1_RXCLK, 0,
		"mii1_rxclk", NULL, "rgmii1_rclk", NULL,
		NULL, NULL, "mcasp0_fsx", NULL),
	_AM335X_MUXENTRY(MII1_RXD3, 0,
		"mii1_rxd3", NULL, "rgmii1_rd3", NULL,
		NULL, NULL, "mcasp0_axr0", NULL),
	_AM335X_MUXENTRY(MII1_RXD2, 0,
		"mii1_rxd2", NULL, "rgmii1_rd2", NULL,
		NULL, NULL, "mcasp0_axr1", NULL),
	_AM335X_MUXENTRY(MII1_RXD1, 0,
		"mii1_rxd1", NULL, "rgmii1_rd1", "mcasp1_axr3",
		"mcasp1_fsr", NULL, NULL, NULL),
	_AM335X_MUXENTRY(MII1_RXD0, 0,
		"mii1_rxd0", NULL, "rgmii1_rd0", "mcasp1_ahclkx",
		"mcasp1_ahclkr", "mcasp1_aclkr", "mcasp0_axr3", NULL),
	_AM335X_MUXENTRY(MII1_REFCLK, 0,
		"rmii1_refclk", NULL, NULL, NULL,
		"mcasp1_axr3", NULL, "mcasp1_ahclkx", NULL),
